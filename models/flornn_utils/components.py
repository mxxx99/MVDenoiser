import functools
from models.flornn_utils.init import init_fn
# from flornn_utils.init import init_fn
import torch
...
class ResBlocks(nn.Module):
    def __init__(self, input_channels, out_channels, num_resblocks, num_channels):
        ...
        self.last_conv = nn.Conv2d(in_channels=num_channels, out_channels=self.out_channels, kernel_size=3, stride=1, padding=1, bias=False)
